...
function tick2() {
    ...
    if (factoryToggle && resources >= 2 * earthIndustryMulitplier * factoryEfficiency[upgradeLevelsIndex.factoryLevel] && energy >= 5 * earthIndustryMulitplier * factoryEfficiency[upgradeLevelsIndex.factoryLevel]) {
        //metal toggle
    ...
    if (refineryToggle && energy >= 10 * earthIndustryMulitplier * fuelRefineryEfficiency[upgradeLevelsIndex.fuelRefineryLevel] && gasoline >= 3 * earthIndustryMulitplier * fuelRefineryEfficiency[upgradeLevelsIndex.fuelRefineryLevel]) {
        //rocket fuel toggle
