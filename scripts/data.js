...
const manualResourceEfficiencyCosts = [
  0, 0, 5, 100, 800, 5000, 25000, 200000, 1000000,
];

//worker upgrade efficiency and money costs
const workerEfficiency = [0, 1, 2, 4, 10, 25, 75, 200, 500, 1000];
const workerEfficiencyCosts = [
  0, 0, 100, 500, 2500, 10000, 50000, 200000, 1000000, 5000000,
];

//worker housing upgrade efficiency and costs
const workerHousingSpace = [
  0, 10, 15, 24, 36, 50, 75, 110, 150, 200, 360, 600, 1000,
];
const workerHousingMoneyCosts = [
  0, 0, 20, 50, 125, 500, 2000, 10000, 40000, 100000, 250000, 800000, 3000000,
];
const workerHousingResourceCosts = [
  0, 0, 50, 120, 250, 600, 2500, 15000, 100000, 300000, 1000000, 4000000,
  12500000,
];
...
const factoryEfficiencyResourceCosts = [
  0, 0, 100000, 400000, 2500000, 12000000,
];
let factoryToggle = false;

//solar panel upgrades + costs
const solarPanelEfficiency = [0, 5, 12, 25, 75, 200, 500];
const solarPanelEfficiencyMoneyCosts = [
  0, 0, 75000, 180000, 800000, 2000000, 10000000,
];
const solarPanelEfficiencyRefinedResourceCosts = [
  0, 0, 500, 1200, 5000, 20000, 75000,
];

//solar panel space costs
const solarPanelSpace = [0, 1, 2, 3, 5, 8, 12, 18, 25];
const solarPanelSpaceCosts = [
  0, 0, 12000, 40000, 150000, 800000, 2500000, 12000000, 50000000,
];
...
const fuelRefineryEfficiencyRefinedResourcesCost = [
  0, 0, 1000, 7500, 25000, 100000,
];
